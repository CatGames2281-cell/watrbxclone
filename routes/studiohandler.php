...
$router->get('/login/RequestAuth.ashx', function(){
    ...
    if($currentuser !== null && isset($_COOKIE["_ROBLOSECURITY"])){
        ...
        echo "https://www.watrbxclone.onrender.com/Login/Negotiate.ashx?suggest=" . $_COOKIE["_ROBLOSECURITY"];
        die();
    } else {
...
$router->get('/my/settings/json', function() {
    ...
    if($currentuser !== null){
        $data = [
            "AccountAgeInDays" => 29,
            "AccountSettingsApiDomain" => "https://www.watrbxclone.onrender.com",
            "AgeBracket" => 0,
            ...
            "ApiProxyDomain" => "https://www.watrbxclone.onrender.com",
            "AuthDomain" => "https://www.watrbxclone.onrender.com",
            "BcExpireDate" => "/Date(-0)/",
            ...
            "LocaleApiDomain" => "https://www.watrbxclone.onrender.com",
            ...
            "NotificationSettingsDomain" => "https://www.watrbxclone.onrender.com",
            "PreviousUserNames" => "",
