...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="https://schemas.xmlsoap.org/soap/envelope/" xmlns:SOAP-ENC="https://schemas.xmlsoap.org/soap/encoding/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ns2="https://watrbxclone.onrender.com/RCCServiceSoap" xmlns:ns1="https://watrbxclone.onrender.com/" xmlns:ns3="https://watrbxclone.onrender.com/RCCServiceSoap12"><SOAP-ENV:Body><ns1:OpenJobExResponse><ns1:OpenJobExResult><ns1:LuaValue><ns1:type>LUA_TSTRING</ns1:type><ns1:value>', '', $response);
        ...
        if(isset($_GET["jobid"])){
            ...
            if($jobinfo !== null){
                $return_array = array(
                    "jobid"=>$jobinfo->jobid,
                    "type"=>$jobinfo->type,
                    "lua_url"=>"https://www.watrbxclone.onrender.com/api/v1/gameserver/fetch-job-lua?jobid=" . $jobinfo->jobid,
                );
