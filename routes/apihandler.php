...
$router->get('/Thumbs/BCOverlay.ashx', function(){
    ...
    if(isset($_GET["username"])){
        ...
        if($userinfo){
            ...
            header("Location: https://cdn.watrbxclone.onrender.com/blank.jpg");
        }
    } else {
        header("Location: https://cdn.watrbxclone.onrender.com/blank.jpg");
    }
...
$router->get('/thumbnail/resolve-hash/{the}', function($the){
    ...
    $json = array(
        "Final"=>true,
        "Url"=>"https://cdn.watrbxclone.onrender.com/$the",
        "width"=>500,
        "height"=>500
    );
            ...
            $shirtxml = '<roblox xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://www.roblox.com/roblox.xsd" version="4">
                        ...
                        <Item class="Shirt" referent="RBX0">
                            ...
                            <Content name="ShirtTemplate">
                                <url>https://www.watrbxclone.onrender.com/asset/?id='.$insertid.'</url>
                            </Content>
            ...
            $shirtxml = '<roblox xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://www.roblox.com/roblox.xsd" version="4">
                            ...
                            <Item class="Decal" referent="RBX0">
                                <Properties>
                                    ...
                                    <Content name="Texture"><url>https://www.watrbxclone.onrender.com/asset/?id='.$insertid.'</url></Content>
...
$router->get('/Game/PlaceLauncher.ashx', function() {
    ...
    $placelauncher = [
        ...
        "status"             => 12,
        "joinScriptUrl"      => null,
        "authenticationUrl"  => "https://www.watrbxclone.onrender.com/Login/Negotiate.ashx",
    ...
    $buildJoinResponse = function($db, $jobinfo, $serverinfo, $placeId, $placelauncher) use ($sendResponse) {
        ...
        $placelauncher["joinScriptUrl"] = "http://www.watrbxclone.onrender.com/Game/Join.ashx?joincode={$joincode}";
...
$router->get('/games/list-json', function(){
    ...
    die('[{"CreatorID":131,"CreatorName":"Dued1","CreatorUrl":"https://www.roblox.com/users/82471/profile","Plays":216463921,"Price":0,"ProductID":0,"IsOwned":false,"IsVotingEnabled":true,"TotalUpVotes":264204,"TotalDownVotes":17667,"TotalBought":0,"UniverseID":47545,"HasErrorOcurred":false,"GameDetailReferralUrl":"https://web.archive.org/web/20170101144445/https://www.roblox.com/games/192800/Work-at-a-Pizza-Place","Url":"https://cdn.watrbxclone.onrender.com/15daa6827d7eee2fcc932c08caa77b00","RetryUrl":null,"Final":true,"Name":"Work at a Pizza Place","PlaceID":192800,"PlayerCount":3313,"ImageId":566142976}]');
...
$router->get('/CharacterFetch.aspx', function(){
    ...
    if(isset($_GET["Id"])){
        ...
        if(!empty($allitems)){
            $charapp = "https://www.watrbxclone.onrender.com/Asset/BodyColors.ashx?Id=$id;";
        }
        ...
        foreach ($allitems as $item){
            ...
            if ($assetinfo === null) {
                $charapp .= "https://www.watrbxclone.onrender.com/asset/?id=". $item->itemid .";";
            } else {
...
$router->get('/Game/Join.ashx', function() {
    ...
    if(isset($_GET["universeId"])){
        ...
        if($universeId == 0){
            ...
            $charappurl = "https://www.watrbxclone.onrender.com/CharacterFetch.aspx?Id=1&placeId=1";

            header("Content-Type: application/json");
            // Construct joinscript
            $joinscript = [
                "ClientPort" => 0,
                "MachineAddress" => "watrbxclone.onrender.com",
                "ServerPort" => $port,
                "PingUrl" => "",
                "PingInterval" => 20,
                "UserName" => "Player1",
                ...
                "BaseUrl" => "https://www.watrbxclone.onrender.com/",
    ...
    if(isset($_GET["joincode"]) && $auth->hasaccount()){
        ...
        $charappurl = "https://www.watrbxclone.onrender.com/CharacterFetch.aspx?Id=" . $currentuser->id . "&placeId=" . $pid;
