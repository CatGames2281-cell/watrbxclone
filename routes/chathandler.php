...
function add_cors(){
    header('Access-Control-Allow-Origin: https://watrbxclone.onrender.com');
    header('Access-Control-Allow-Origin: https://www.watrbxclone.onrender.com');
            ...
            $allfriends = $friends->get_friends($userid);
                foreach ($allfriends as $friend){
                    $response["Friends"][] = [
                        ...
                        "AvatarThumb" => [
                            "Final" => true,
                            "Url" => "https://www.watrbxclone.onrender.com/images/defaultimage.png"
                        ],
                        "UserPresenceType"=>1,
                    ];
                }
...
$router->get('/thumbnail/avatar-headshot',function(){
    die('{"Url": "https://www.watrbxclone.onrender.com/images/defaultimage.png", "Final": true }');
});
