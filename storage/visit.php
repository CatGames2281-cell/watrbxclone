...
game:GetService("InsertService"):SetUserSetsUrl("https://www.watrbxclone.onrender.com/Game/Tools/InsertAsset.ashx?nsets=20&type=user&userid=")
game:GetService("InsertService"):SetCollectionUrl("https://www.watrbxclone.onrender.com/Game/Tools/InsertAsset.ashx?sid=")
game:GetService("InsertService"):SetAssetUrl("https://www.watrbxclone.onrender.com/Asset/?id=")
game:GetService("InsertService"):SetAssetVersionUrl("https://www.watrbxclone.onrender.com/Asset/?assetversionid=")

pcall(function() game:GetService("SocialService"):SetFriendUrl("https://www.watrbxclone.onrender.com/Game/LuaWebService/HandleSocialRequest.ashx?method=IsFriendsWith&playerid=&userid=") end)
pcall(function() game:GetService("SocialService"):SetBestFriendUrl("https://www.watrbxclone.onrender.com/Game/LuaWebService/HandleSocialRequest.ashx?method=IsBestFriendsWith&playerid=&userid=") end)
pcall(function() game:GetService("SocialService"):SetGroupUrl("https://www.watrbxclone.onrender.com/Game/LuaWebService/HandleSocialRequest.ashx?method=IsInGroup&playerid=&groupid=") end)
...
pcall(function() game:GetService("Players"):SetBuildUserPermissionsUrl("https://www.watrbxclone.onrender.com/Game/BuildActionPermissionCheck.ashx?assetId=0&userId=&isSolo=true") end)
...
function doVisit()
    ...
    player.CharacterAppearance = "https://www.watrbxclone.onrender.com/CharacterFetch.aspx?userId=<?=$id?>&placeId=1"
...
if success then
    ...
    if true then
        game:HttpPost("https://www.watrbxclone.onrender.com/Error/Lua.ashx?", "Visit.lua: " .. err)
    end
end
<?php
$data = "\r\n" . ob_get_clean();
