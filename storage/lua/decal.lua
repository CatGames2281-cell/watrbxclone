...
local baseUrl = "http://www.watrbxclone.onrender.com"
...
local success = pcall(function()
	image, requestedUrls = ThumbnailGenerator:ClickTexture(string.gsub(decal.Texture, "roblox.com", "watrbxclone.onrender.com"), fileExtension, 1024, 1024)
end)
