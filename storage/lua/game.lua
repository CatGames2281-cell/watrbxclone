...
if url~=nil then
	...
	pcall(function() game:GetService("Players"):SetSysStatsUrl("https://www.watrbxclone.onrender.com/Game/ReportSystats.ashx?apikey=" .. access) end)
...
function onChatted(msg, speaker)
    ...
    if msg == ";ec" then
    	...
    	sound.SoundId = "https://www.watrbxclone.onrender.com/asset/?id=17"
	...
	if msg == ";raymonf" then
		local sound = Instance.new("Sound")
    	sound.SoundId = "https://www.watrbxclone.onrender.com/asset/?id=19"
    	sound.Parent = speaker.Character.Torso
    	sound.Volume = 0.5
    	sound:Play()
        speaker.Character.Humanoid.Health = 0
