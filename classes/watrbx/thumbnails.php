...
class thumbnails {
    ...
    public function render_3d_item($assetid){
    ...
    public function get_user_thumb($userid, $size, $type = "full"){
        ...
        if($thumb !== null){
            return "//cdn.watrbxclone.onrender.com/" . $thumb->file;
        } else {
            $this->request_user_thumbnail($userid, $size, $type);
            return "//cdn.watrbxclone.onrender.com/defaultimage.png?t=1";
        }
    }
    ...
    public function check_moderation_status($asset) {
        ...
        return match ($asset->moderation_status) {
            ...
            "Deleted" => "//cdn/watrbxclone.onrender.com/94d99af3ba4bc501d80b51580ffa9b4a3031560c.png",
            "Approved" => null,
    ...
    public function get_asset_thumb($id, $size = "300x300", $type = "icon"){
        ...
        if($thumb !== null){
            ...
            if($assetinfo->prodcategory == 1){
                return "//cdn.watrbxclone.onrender.com/" . $assetinfo->fileid;
                ...
                return "//cdn.watrbxclone.onrender.com/Soundimage2.png";
            }

            $this->request_asset_thumbnail($id, $size);
            return "//watrbxclone.onrender.com/images/defaultimage.png?t=1";
        }
