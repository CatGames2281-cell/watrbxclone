...
<div class="section">
    <div id="AjaxCommentsContainer" class="comments-container"
         ...
         data-signin-url="https://www.watrbxclone.onrender.com/newlogin?returnUrl=%2Fgames%2F<?=$assetinfo->id?>%2FWork-at-a-Pizza-Place">
        <h3>Comments</h3>
    ...
    <div class="footer">
        <ul class="row footer-links">
                <li class="col-xs-4 col-sm-2 footer-link">
                    <a href="https://corp.watrbxclone.onrender.com" class="roblox-interstitial" target="_blank">
                        <h2>About Us</h2>
                    </a>
                </li>
                <li class="col-xs-4 col-sm-2 footer-link">
                    <a href="https://corp.watrbxclone.onrender.com/jobs" class="roblox-interstitial" target="_blank">
                        <h2>Jobs</h2>
                    </a>
                </li>
            <li class="col-xs-4 col-sm-2 footer-link">
                <a href="https://blog.watrbxclone.onrender.com" target="_blank">
                    <h2>Blog</h2>
                </a>
            </li>
            <li class="col-xs-4 col-sm-2 footer-link">
            ...
            <li class="col-xs-4 col-sm-2 footer-link">
                <a href="https://corp.watrbxclone.onrender.com/parents" class="roblox-interstitial" target="_blank">
                    <h2>Parents</h2>
                </a>
            </li>
            <li class="col-xs-4 col-sm-2 footer-link">
                <a href="https://en.help.watrbxclone.onrender.com/" class="roblox-interstitial" target="_blank">
                    <h2>Help</h2>
                </a>
            </li>
        </ul>
        <p class="footer-note">
            ROBLOX, "Online Building Toy", characters, logos, names, and all related indicia are trademarks of <a target="_blank" href="https://corp.watrbxclone.onrender.com" class="rbx-link roblox-interstitial">ROBLOX Corporation</a>, ©2015.
...
<img src="/timg/rbx" style="position: absolute"/>
            ...
            <button id="SignupButton" type="button" tabindex="9" class="rbx-btn-primary-md" rbx-form-interaction name="signupSubmit" ng-disabled="isSubmitting" data-signup-api-url="https://api.watrbxclone.onrender.com/signup/v1" ng-click="submitSignup($event)" ng-keypress="submitSignup($event)">Sign Up and Play!</button>
            <noscript>
        ...
        <div class="login-container" ng-controller="LoginController">
            <div class="login-input-area" ng-form name="loginForm" rbx-form-context context="PlayButton" ng-cloak ng-show="isSectionShown">
                ...
                <div class="rbx-form-group" ng-class="{'has-error': ((loginForm.password.$dirty || badSubmit) && loginForm.password.$invalid || loginForm.password.showValidation), 'has-success': loginForm.password.$dirty && loginForm.password.$valid}">
                    ...
                    <a href="https://www.watrbxclone.onrender.com/login/resetpasswordrequest.aspx" target="_top" class="rbx-link rbx-font-sm forgot-password-link">Forgot password?</a>
                ...
                <button id="login-button" type="button" ng-disabled="isSubmitting || isTwoStepSectionShown" rbx-form-interaction name="loginSubmit" tabindex="3" class="rbx-btn-primary-md login-button" data-login-api-url="https://api.watrbxclone.onrender.com/login/v1" data-two-step-code-request-url="https://api.watrbxclone.onrender.com/twostepverification/request-unauthenticated" data-two-step-verification-api-url="https://api.watrbxclone.onrender.com/twostepverification/verify-unauthenticated" ng-click="submitLogin($event)">Log In</button>
                ...
                <div class="two-step-verification-container" ng-cloak ng-show="isTwoStepSectionShown">
                    <div class="two-step-verification-input-area" ng-form name="twoStepVerificationForm" rbx-form-context context="PlayButton">
                        ...
                        <button id="two-step-button" ng-disabled="isSubmitting" type="button" tabindex="2" class="rbx-btn-primary-md two-step-button" rbx-form-interaction name="twoStepSubmit" ng-click="submitTwoStepCode($event)" data-login-api-url="https://api.watrbxclone.onrender.com/login/v1">Submit</button>
    ...
    <div class="captcha-container" ng-controller="CaptchaController" ng-form name="captchaForm" rbx-form-context context="PlayButton" ng-cloak ng-show="isSectionShown">
        ...
        <button id="CaptchaSubmitButton" class="rbx-btn-primary-md captcha-submit-button"
                data-signup-captcha-api-url="https://api.watrbxclone.onrender.com/captcha/validate/signup"
                data-log-in-captcha-api-url="https://api.watrbxclone.onrender.com/captcha/validate/login"
...
<div id="usernotifications-data-model"
     class="hidden"
     data-notificationsdomain="https://notifications.watrbxclone.onrender.com/"
...
<div id="ProtocolHandlerClickAlwaysAllowed" class="ph-clickalwaysallowed" style="display:none;">
    ...
    <div id="videoPrerollPanel" style="display:none">
        ...
        <div id="videoPrerollJoinBC">
            ...
            <a href="https://www.watrbxclone.onrender.com/premium/membership?ctx=preroll" target="_blank" class="btn-medium btn-primary" id="videoPrerollJoinBCButton">Join Builders Club</a>
        </div>
    </div>   
    ...
    <div style="min-height: 275px; background-color: white;">
        ...
        <div class="RevisedFooter">
            <div style="width:200px;margin:10px auto 0 auto;">
                <a href="/?returnUrl=http%3A%2F%2Fwww.watrbxclone.onrender.com%2Fgames%2F<?=$assetinfo->id?>%2FWork-at-a-Pizza-Place"><div class="RevisedCharacterSelectSignup"></div></a>
                <a class="HaveAccount" href="https://www.watrbxclone.onrender.com/newlogin?returnUrl=http%3A%2F%2Fwww.watrbxclone.onrender.com%2Fgames%2F<?=$assetinfo->id?>%2FWork-at-a-Pizza-Place">I have an account</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        $(function () {
            Roblox.CookieUpgrader.domain = 'watrbxclone.onrender.com';
